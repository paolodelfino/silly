...
type MoviesGetDetailsResponse<
  AppendToResponse extends MoviesAppendToResponse[] | undefined,
> = MoviesGetDetailsBaseResponse & AppendToResponseType<AppendToResponse>;
...
type PeopleGetDetailsResponse<
  AppendToResponse extends PeopleAppendToResponse[] | undefined,
> = PeopleGetDetailsBaseResponse & AppendToResponseType<AppendToResponse>;
...
type TVGetDetailsResponse<
  AppendToResponse extends TVAppendToResponse[] | undefined,
> = TVGetDetailsBaseResponse & AppendToResponseType<AppendToResponse>;
...
type TVEpisodesGetDetailsResponse<
  AppendToResponse extends TVEpisodesAppendToResponse[] | undefined,
> = TVEpisodesGetDetailsBaseResponse & AppendToResponseType<AppendToResponse>;
...
type TVSeasonsGetDetailsResponse<
  AppendToResponse extends TVSeasonsAppendToResponse[] | undefined,
> = TVSeasonsGetDetailsBaseResponse & AppendToResponseType<AppendToResponse>;
...
type TVSeasonsAppendToResponse =
  | "account_states"
  | "aggregate_credits"
  | "changes"
  | "credits"
...
type TVEpisodesAppendToResponse =
  | "account_states"
  | "changes"
  | "credits"
  | "external_ids"
...
type AppendToResponseType<
  AppendToResponse extends
    | (
        | MoviesAppendToResponse
        | TVAppendToResponse
        | PeopleAppendToResponse
        | TVSeasonsAppendToResponse
        | TVEpisodesAppendToResponse
      )[]
    | undefined,
...
interface IMovies {
  getDetails: <T extends MoviesAppendToResponse[]>(
    movieId: number,
    params?: MoviesGetDetailsParams<T>,
  ) => Promise<MoviesGetDetailsResponse<T>>;
  getAccountStates: (
    movieId: number,
...
interface IPeople {
  getDetails: <T extends PeopleAppendToResponse[]>(
    personId: number,
    params?: PeopleGetDetailsParams<T>,
  ) => Promise<PeopleGetDetailsResponse<T>>;
  getChanges: (
    personId: number,
...
interface ITV {
  getDetails: <T extends TVAppendToResponse[]>(
    tvId: number,
    params?: TVGetDetailsParams<T>,
  ) => Promise<TVGetDetailsResponse<T>>;
  getAccountStates: (
    tvId: number,
...
interface ITVSeasons {
  getDetails: <T extends TVSeasonsAppendToResponse[]>(
    tvId: number,
    seasonNumber: number,
    params?: TVSeasonsGetDetailsParams<T>,
  ) => Promise<TVSeasonsGetDetailsResponse<T>>;
  getAccountStates: (
    tvId: number,
    seasonNumber: number,
...
interface ITVEpisodes {
  getDetails: <T extends TVEpisodesAppendToResponse[]>(
    tvId: number,
    seasonNumber: number,
    episodeNumber: number,
    params?: TVEpisodesGetDetailsParams<T>,
  ) => Promise<TVEpisodesGetDetailsResponse<T>>;
  getAccountStates: (
    tvId: number,
    seasonNumber: number,
    episodeNumber: number,
...
export {
  ...
  CreditsGetDetailsMedia,
  CreditsGetDetailsPerson,
  CreditsGetDetailsResponse,
  CreditsGetDetailsSeason,
  DiscoverMovieDiscoverParams,
  DiscoverMovieDiscoverResponse,
  DiscoverMovieDiscoverResult,
  DiscoverTVDiscoverParams,
  DiscoverTVDiscoverResponse,
  DiscoverTVDiscoverResult,
  FindFindByIdMovieResult,
  FindFindByIdParams,
  FindFindByIdPersonResult,
  FindFindByIdPersonResultKnownForMovie,
  FindFindByIdPersonResultKnownForTV,
  FindFindByIdResponse,
  FindFindByIdTvEpisodeResult,
  FindFindByIdTvResult,
  FindFindByIdTvSeasonResult,
  ...
  MoviesGetAlternativeTitlesTitle,
  MoviesGetChangesChange,
  MoviesGetChangesItem,
  ...
  MoviesGetDetailsProductionCompany,
  MoviesGetDetailsProductionCountry,
  MoviesGetDetailsResponse,
  MoviesGetDetailsSpokenLanguage,
  MoviesGetExternalIdsResponse,
  MoviesGetImagesBackdrop,
  MoviesGetImagesParams,
  MoviesGetImagesResponse,
  MoviesGetKeywordsKeyword,
  MoviesGetKeywordsResponse,
  MoviesGetLatestGenre,
  MoviesGetLatestParams,
  MoviesGetLatestResponse,
  MoviesGetListsParams,
  MoviesGetListsResponse,
  MoviesGetListsResult,
  MoviesGetNowPlayingDates,
  ...
  MoviesGetReleaseDatesReleaseDate,
  MoviesGetReleaseDatesResponse,
  MoviesGetReleaseDatesResult,
  MoviesGetReviewsAuthorDetails,
  MoviesGetReviewsParams,
  MoviesGetReviewsResponse,
  MoviesGetReviewsResult,
  ...
  TVGetAggregateCreditsCast,
  TVGetAggregateCreditsParams,
  TVGetAggregateCreditsResponse,
  TVGetAggregateCreditsRole,
  TVGetAlternativeTitlesParams,
  TVGetAlternativeTitlesResponse,
  TVGetAlternativeTitlesResult,
  TVGetChangesChange,
  TVGetChangesItem,
  TVGetChangesOriginalValueClass,
  TVGetChangesParams,
  TVGetChangesPoster,
  TVGetChangesResponse,
  TVGetChangesValueClass,
  TVGetContentRatingsParams,
  TVGetContentRatingsResponse,
  TVGetContentRatingsResult,
  TVGetCreditsCast,
  TVGetCreditsParams,
  TVGetCreditsResponse,
  TVGetDetailsBaseResponse,
  TVGetDetailsCreatedBy,
  TVGetDetailsGenre,
  TVGetDetailsLastEpisodeToAir,
  TVGetDetailsNetwork,
  TVGetDetailsParams,
  TVGetDetailsProductionCountry,
  TVGetDetailsResponse,
  TVGetDetailsSeason,
  TVGetDetailsSpokenLanguage,
  TVGetEpisodeGroupsNetwork,
  TVGetEpisodeGroupsParams,
  TVGetEpisodeGroupsResponse,
  TVGetEpisodeGroupsResult,
  ...
  TVGetTVAiringTodayResult,
  TVGetTVOnTheAirParams,
  TVGetTVOnTheAirResponse,
  TVGetTVOnTheAirResult,
  TVGetTopRatedParams,
  TVGetTopRatedResponse,
  TVGetTopRatedResult,
  TVGetTranslationsData,
  TVGetTranslationsResponse,
  TVGetTranslationsTranslation,
  TVGetVideosParams,
  TVGetVideosResponse,
  TVGetVideosResult,
  TVGetWatchProvidersAr,
  TVGetWatchProvidersAt,
  TVGetWatchProvidersFlatrate,
  TVGetWatchProvidersResponse,
  TVGetWatchProvidersResults,
  TVGetWatchProvidersRu,
  TVRateTVShowsBody,
  TVRateTVShowsParams,
  TVRateTVShowsResponse,
  TVSeasonsAppendToResponse,
  TVSeasonsAppendToResponseTypes,
  TVSeasonsGetAccountStatesParams,
  TVSeasonsGetAccountStatesRatedClass,
  TVSeasonsGetAccountStatesResponse,
  TVSeasonsGetAccountStatesResult,
  TVSeasonsGetAggregateCreditsCast,
  TVSeasonsGetAggregateCreditsJob,
  TVSeasonsGetAggregateCreditsParams,
  TVSeasonsGetAggregateCreditsResponse,
  TVSeasonsGetAggregateCreditsRole,
  TVSeasonsGetChangesChange,
  TVSeasonsGetChangesItem,
  TVSeasonsGetChangesParams,
  TVSeasonsGetChangesResponse,
  TVSeasonsGetChangesValueClass,
  TVSeasonsGetCreditsCast,
  ...
  TVSeasonsGetImagesPoster,
  TVSeasonsGetImagesResponse,
  TVSeasonsGetTranslationsData,
  TVSeasonsGetTranslationsParams,
  TVSeasonsGetTranslationsResponse,
  TVSeasonsGetTranslationsTranslation,
  TVSeasonsGetVideosParams,
  TVSeasonsGetVideosResponse,
  TVSeasonsGetVideosResult,
  ...
  V4ListGetListComments,
  V4ListGetListCreatedBy,
  V4ListGetListParams,
  V4ListGetListResponse,
  V4ListGetListResult,
  V4ListRemoveItemsBody,
  V4ListRemoveItemsItem,
  V4ListRemoveItemsResponse,
  V4ListRemoveItemsResult,
  V4ListUpdateItemsBody,
  V4ListUpdateItemsItem,
  V4ListUpdateItemsResponse,
  V4ListUpdateItemsResult,
