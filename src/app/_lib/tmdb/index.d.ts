...
type GetDetailsResponse<AppendToResponse extends MoviesAppendToResponse[] | undefined> = MoviesGetDetailsResponse & AppendToResponseType<AppendToResponse>;
...
interface PeopleGetDetailsResponse {
    birthday: string;
    known_for_department: string;
    deathday: null;
    id: number;
...
interface TVGetDetailsResponse {
    backdrop_path: string;
...
interface TVEpisodesGetDetailsResponse {
    air_date: string;
...
interface TVSeasonsGetDetailsResponse {
    _id: string;
    air_date: string;
